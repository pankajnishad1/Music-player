...
function Musicpage() {
  ...
  return (
    <div className='container-div ' >
      <h1 className='mt-2 mb-6 ml-10 font-bold text-[1.7rem] sm:text-[2rem] md:text-[2.5rem]'>Latest Songs</h1> 
            ...
            return (
              <div onClick={()=>{
                  ...
                  <div className=' relative  flex items-center rounded-3xl overflow-hidden'>
                   <img className=' rounded-3xl object-cover object-center hover:scale-[1.04] transition-all duration-300 ease-in  aspect-square h-44 sm:h-48 md:h-56 lg:h-64' 
